...
class Attendance extends Model {
  ...
  const Attendance._internal({required this.id, Clockin, Clockout, Date, UserID, WorkingHours}): _Clockin = Clockin, _Clockout = Clockout, _Date = Date, _UserID = UserID, _WorkingHours = WorkingHours;
  
  factory Attendance({String? id, String? Clockin, String? Clockout, String? Date, String? UserID, String? WorkingHours}) {
  ...
  Attendance copyWith({String? id, String? Clockin, String? Clockout, String? Date, String? UserID, String? WorkingHours}) {
    return Attendance(
      id: id ?? this.id,
